...
if (isset($restauranter)) {
  ...
  class CoursesTaxonomyWidget extends WP_Widget
  {
      ...
      public function widget($args, $instance)
      {
          ...
          echo $before_widget;
          ?><aside class="widget widget_restauranter_courses">
          
          <div id="restauranter_courses_wrap">
          <?php
          ...
          <ul id="courses-list" class="restauranter_widget_list">
          <?php
      ...
      public function form($instance)
      {
        ...
        $defaults = array( 'title' => __('Courses', 'example') );
 ...
 <?php
  ...
  class DietsTaxonomyWidget extends WP_Widget
  {
      ...
      public function widget($args, $instance)
      {
          ...
          ?>
          <ul id="diets-list" class="restauranter_widget_list">
          <?php
          foreach ($tax_terms as $tax_term) {
          echo '<li>' . '<a href="' . esc_attr(get_term_link($tax_term, $taxonomy)) . '" title="' . sprintf( __( "View all posts in %s" ), $tax_term->name ) . '" ' . '>' . $tax_term->name.'</a></li>';
          }
